...
#define STATICALLY_CLASSNAME "cn/tursom/netty/incubator/codec/quic/QuicheNativeStaticallyReferencedJniMethods"
#define QUICHE_CLASSNAME "cn/tursom/netty/incubator/codec/quic/Quiche"
...
static JNINativeMethod* createDynamicMethodsTable(const char* packagePrefix) {
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/QuicheLogger;)V", dynamicTypeName, error);
...
static jint netty_quiche_JNI_OnLoad(JNIEnv* env, char const* packagePrefix) {
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/QuicheLogger", name, done);
