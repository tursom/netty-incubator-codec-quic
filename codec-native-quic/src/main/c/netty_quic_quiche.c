...
#define STATICALLY_CLASSNAME "cn/tursom/quicmc/netty/quic/QuicheNativeStaticallyReferencedJniMethods"
#define QUICHE_CLASSNAME "cn/tursom/quicmc/netty/quic/Quiche"
...
static JNINativeMethod* createDynamicMethodsTable(const char* packagePrefix) {
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/QuicheLogger;)V", dynamicTypeName, error);
...
static jint netty_quiche_JNI_OnLoad(JNIEnv* env, char const* packagePrefix) {
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/QuicheLogger", name, done);
