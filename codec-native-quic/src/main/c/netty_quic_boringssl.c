...
#define STATICALLY_CLASSNAME "cn/tursom/netty/incubator/codec/quic/BoringSSLNativeStaticallyReferencedJniMethods"
#define CLASSNAME "cn/tursom/netty/incubator/codec/quic/BoringSSL"
...
jint netty_boringssl_JNI_OnLoad(JNIEnv* env, const char* packagePrefix) {
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLTask", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLPrivateKeyMethodTask", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLPrivateKeyMethodSignTask", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLPrivateKeyMethod;)V", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLPrivateKeyMethodDecryptTask", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLCertificateCallbackTask", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLCertificateCallback;)V", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLCertificateVerifyCallbackTask", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLCertificateVerifyCallback;)V", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLHandshakeCompleteCallback", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLTlsextServernameCallback", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLKeylogCallback", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLSessionCallback", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/netty/incubator/codec/quic/BoringSSLSessionTicketCallback", name, done);
