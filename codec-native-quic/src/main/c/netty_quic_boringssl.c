...
#define STATICALLY_CLASSNAME "cn/tursom/quicmc/netty/quic/BoringSSLNativeStaticallyReferencedJniMethods"
#define CLASSNAME "cn/tursom/quicmc/netty/quic/BoringSSL"
...
jint netty_boringssl_JNI_OnLoad(JNIEnv* env, const char* packagePrefix) {
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLTask", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLPrivateKeyMethodTask", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLPrivateKeyMethodSignTask", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLPrivateKeyMethod;)V", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLPrivateKeyMethodDecryptTask", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLCertificateCallbackTask", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLCertificateCallback;)V", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLCertificateVerifyCallbackTask", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLCertificateVerifyCallback;)V", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLHandshakeCompleteCallback", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLTlsextServernameCallback", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLKeylogCallback", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLSessionCallback", name, done);
    ...
    NETTY_JNI_UTIL_PREPEND(packagePrefix, "cn/tursom/quicmc/netty/quic/BoringSSLSessionTicketCallback", name, done);
